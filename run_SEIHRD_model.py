...
if __name__ == "__main__":
    ...
    for (i,state) in enumerate(states_mex):
        ...
        r = 0.65 # 0.7 r denotes the fraction of latent cases with respect to the confirmed cases. This is, E0 + A0 = r * I0
        ...
        projection_state_i_scenario_1 = solve(SEAIHRD_markov_step, x0_vec[i], 0.0, n_days, *params_1) * N
        projection_state_i_scenario_2 = solve(SEAIHRD_markov_step, x0_vec[i], 0.0, n_days, *params_2) * N
        projection_state_i_scenario_3 = solve(SEAIHRD_markov_step, x0_vec[i], 0.0, n_days, *params_3) * N
